    ...
    <div className="fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        <div className="border border-emerald-300 bg-emerald-50 p-4">
          <div className="font-mono text-[11px] uppercase tracking-wider text-emerald-800">
            Compliance export backend ready
          </div>
          <p className="mt-2 font-mono text-[12px] text-emerald-900">
            Completed JSON and PDF exports are generated by the backend read model.
            Downloads use the persisted export artifact for the selected time range.
          </p>
        </div>
